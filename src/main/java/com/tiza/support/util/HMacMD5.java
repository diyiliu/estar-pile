...
public class HMacMD5 {
	...
	public static void main(String[] args) {
		System.out.println(HMacMD5.getHmacMd5Str("1234567890abcdef", "19C786A5-FF0F-420A-98F2-2CFEBC3AA548185532969633702120244204201708031431001234WvBrkSIvogKwGdgb0CboHztrzMVaSDHc9x7ZBX1hZU3DfPtIbFRHtsnZAenVfnfp"));
	/*
		 * 前者为加密秘钥，后者为加密数据，生产sig。
		 */
	}
}